...
public func runStanSummaryResult() -> Dictionary<String, (mean: Double, mcse: Double?, std: Double, mad: Double, p05: Double?, p50: Double?, p95: Double?, ess_bulk: Double?, ess_tail: Double?, ess_bulk_per_s: Double?, rhat: Double?)> {
